...
const lakes = ref<Lake[]>([
  ...
  { name: 'Озеро Поганка', lat: 54.920822, lng: 69.052810 },
  { name: 'Озеро Горькое', lat: 54.948165, lng: 68.950365},
  { name: 'Озеро Паганка', lat: 54.824701 , lng: 69.139179},
  { name: 'Озеро Дикое', lat: 54.839850 , lng: 69.131376},
  { name: 'Озеро Соленое', lat: 54.809068 , lng: 69.138382},
  { name: 'Озеро Большое Тинное', lat: 54.803751, lng:69.156091},
  { name: 'Озеро Гусиное', lat:54.792836, lng:69.137283 }, 
  { name: 'Озеро Пеньковское', lat:54.964895, lng:69.262492},
